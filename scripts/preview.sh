...
echo "<?xml version='1.0' encoding='UTF-8' standalone='yes' ?><gpx version='1.1' xmlns='http://www.topografix.com/GPX/1/1'   width='12544' height='12544' zoom='13' mapDensity='1'  renderingProperties='appMode=default,lang=en,contourLines=11,contourDensity=medium_w,contourWidth=thin'  renderingName='src/rendering/offroad-survey'>  <wpt lat='19.20742852680121' lon='98.81103515625'>    <name>13</name>    <extensions>      <maps>Thailand_asia_22_02_14,Thailand_asia_22_02_13,Thailand_asia_22_02_12,Thailand_asia_22_02_11,Thailand_asia_22_02_10,Thailand_asia_22_02_00,Thailand_asia_22_02_09,Thailand_asia_22_02_08,Thailand_asia_22_02_07,Thailand_asia_22_02_06,Thailand_asia_22_02_05,Thailand_asia_22_02_04,Thailand_asia_22_02_03,Thailand_asia_22_02_02,Thailand_asia_22_02_01,Thailand_asia_22_01_00,Thailand_asia_22_01_31,Thailand_asia_22_01_30,Thailand_asia_22_01_29,Thailand_asia_22_01_28,Thailand_asia_22_01_27,Thailand_asia_22_01_26,Thailand_asia_22_01_25,Thailand_asia_22_01_24,Thailand_asia_22_01_23,Thailand_asia_22_01_22,Thailand_asia_22_01_21,Thailand_asia_22_01_20,Thailand_asia_22_01_19,Thailand_asia_22_01_18,Thailand_asia_22_01_17,Thailand_asia_22_01_16,Thailand_asia_22_01_15,Thailand_asia_22_01_14,Thailand_asia_22_01_13,Thailand_asia_22_01_12,Thailand_asia_22_01_11,Thailand_asia_22_01_10,Thailand_asia_22_01_09,Thailand_asia_22_01_08,Thailand_asia_22_01_07,Thailand_asia_22_01_06,Thailand_asia_22_01_05,Thailand_asia_22_01_04,Thailand_asia_22_01_03,Thailand_asia_22_01_02,Thailand_asia_22_01_01,Thailand_asia,Thailand_asia.srtm</maps>      <zoom>13</zoom>    </extensions>  </wpt></gpx>" > ./tmp/13.gpx
...
echo "<!DOCTYPE html><html><head>  <title>OsmAnd Offroad-Survey Plugin Preview (Northern Thailand)</title>  <meta charset='utf-8' />  <meta name='viewport' content='width=device-width, initial-scale=1.0'>    <link rel='stylesheet' href='https://unpkg.com/leaflet@1.7.1/dist/leaflet.css' integrity='sha512-xodZBNTC5n17Xt2atTPuE1HxjVMSvLVW9ocqUKLsCC5CXdbqCmblAshOMAS6/keqq/sMZMZ19scR4PsZChSR7A==' crossorigin='' />    <link rel='stylesheet' href='https://cdn.jsdelivr.net/npm/font-awesome@4.7.0/css/font-awesome.min.css' />    <link rel='stylesheet' href='https://aratcliffe.github.io/Leaflet.contextmenu/dist/leaflet.contextmenu.css' />    <script src='https://unpkg.com/leaflet@1.7.1/dist/leaflet.js' integrity='sha512-XQoYMqMTK8LvdxXYG3nZ448hOEQiglfqkJs1NOQV44cWnUrBc8PkAOcXy20w0vlaXaVUearIOBhiXZ5V3ynxwA==' crossorigin=''></script>    <script src='http://aratcliffe.github.io/Leaflet.contextmenu/dist/leaflet.contextmenu.js'></script>    <style>    html,body,#map{width:100%;height:100%;margin: 0; padding: 0;}    #crosshair { left: calc(50% - 10px); top: calc(50% - 10px); position: absolute; width: 20px; height: 20px; z-index: 10000; text-align: center; font-weight: normal; font-size: 32px; color: #222; text-shadow: 1px 1px 3px #fff; }  </style></head><body><div id='map'></div><div id='crosshair'>⌖</div><script>  const hash = location.hash || '#map=13/19.20742852680121/98.81103515625';  const tokens = hash.substring(5).split('/');  if (!location.hash) {    history.pushState(null,null, hash);  }  const center = [ tokens[1], tokens[2] ], zoom = tokens[0];  const pluginLayer = L.tileLayer('./tiles/{z}/{x}/{y}.png?date=2022-02-14', {    attribution: '',    minNativeZoom: 13,    maxNativeZoom: 13  });  var map = new L.Map('map', {     minZoom: 12,     maxZoom: 15,    maxBounds: 49 > 0 && 49 > 0 ? L.latLngBounds(       L.latLng(20.200346006493724, 97.75634765625),       L.latLng(18.166730410221927, 99.90966796875)    ) : undefined,    layers: [ pluginLayer ],    zoomControl: true,    contextmenu: true,    contextmenuWidth: 200,    contextmenuItems: [      /*{        text: 'Center map here',        callback: (e) => map.panTo(e.latlng)      },      '-',*/      {        text: 'Edit in OSM (Maxar)',        callback: (e) => window.open('http://www.openstreetmap.org/edit#background=Maxar-Standard&map=16/' + e.latlng.lat + '/' + e.latlng.lng)      },      {        text: 'Edit in OSM (WorldTopoMap)',        callback: (e) => window.open('http://www.openstreetmap.org/edit#background=custom:https://{switch:services,server}.arcgisonline.com/arcgis/rest/services/World_Topo_Map/MapServer/tile/{zoom}/{y}/{x}&map=16/' + e.latlng.lat + '/' + e.latlng.lng)      }          ]  })  .setView(center, 13);  map.attributionControl.setPrefix('');  map.on('moveend', (e) => {    const center = e.target.getCenter(), zoom = e.target.getZoom();    history.pushState(null,null, '#map=' + zoom + '/' + center.lat + '/' + center.lng);        });  var baseLayers = {    'osmand-offroad-survey-plugin': pluginLayer,    'cyclemap': L.tileLayer('https://{s}.tile.thunderforest.com/cycle/{z}/{x}/{y}.png?apikey=6170aad10dfd42a38d4d8c709a536f38'),    'opentopomap': L.tileLayer('https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png'),    'worldtopomap': L.tileLayer('https://services.arcgisonline.com/arcgis/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}'),    'komoot': L.tileLayer('https://{s}.tile.komoot.de/komoot/{z}/{x}/{y}.png?lang=en'),    'mapy.cz': L.tileLayer('https://mapserver.mapy.cz/base-m/{z}-{x}-{y}?sdk=HgUbCgUbGkgqAQkYBxYEHQNHQlJfR1VfQlBZSw%3D%3D'),    'google (terrain)': L.tileLayer('https://mt3.Google.com/vt?z={z}&x={x}&y={y}&lyrs=p'),    'google (satellite)': L.tileLayer('https://mt3.Google.com/vt?z={z}&x={x}&y={y}&lyrs=y')  };  var overlays = {    'OSM GPS traces': L.tileLayer('https://{s}.gps-tile.openstreetmap.org/lines/{z}/{x}/{y}.png'),  };  L.tileLayer('./tiles/{z}/{x}/{y}-hillshade.png', { minNativeZoom: 12, maxNativeZoom: 12, transparency: true, opacity: 0.2 }).addTo(map);    L.control.layers(baseLayers, overlays).addTo(map);</script></body></html>" > ../../OSM/osm-tools/osmand-offroad-survey-plugin-preview/index.html
