...
echo "<?xml version='1.0' encoding='UTF-8' standalone='yes' ?><gpx version='1.1' xmlns='http://www.topografix.com/GPX/1/1'   width='8960' height='7680' zoom='13'   renderingProperties='appMode=default,lang=en,contourLines=12,contourDensity=medium_w,contourWidth=thin'  renderingName='src/rendering/offroad-survey'>  <wpt lat='19.2085242' lon='98.8059622'>    <name>13</name>    <extensions>      <maps>Thailand_asia_22_02_00,Thailand_asia_22_01_00,Thailand_asia,Thailand_asia.srtm</maps>      <zoom>13</zoom>    </extensions>  </wpt></gpx>" > ./tmp/13.gpx
