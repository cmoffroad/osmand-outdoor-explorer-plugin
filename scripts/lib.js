...
<gpx version='1.1' xmlns='http://www.topografix.com/GPX/1/1'
  ...
  renderingProperties='activityMode=enduro,lang=en,hideContour=true,hideBuildings=true,hideBoundaries=false,hideLanduse=true,hideWater=true,groundSurveyMode=true,showFixme=true'
