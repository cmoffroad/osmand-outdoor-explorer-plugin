...
<gpx version='1.1' xmlns='http://www.topografix.com/GPX/1/1'
  ...
  renderingProperties='activityMode=enduro,lang=en,hideContour=true,hideBuildings=true,hideBoundaries=true,hideLanduse=true,hideWater=true,groundSurveyMode=true,showFixme=true'
